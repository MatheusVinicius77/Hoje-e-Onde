        ...
        <div className={styles.container}>
            <div className={`${styles.containerAuth}`}>
                <div className={`${styles.asideContent}`}>
                    ...
                    <p className={styles.p2}>Já tem uma conta? <Link to={'/'}>clique aqui!</Link> </p>
                ...
                <div className={`${styles.login}`}>
                    ...
                    <form className={`${styles.formAuth}`} action="#">
                        ...
                        <Button onClick={handleContact} className={styles.dale} style={{ width: '100%', height: '4vh' }} placeholder={'Criar conta'}></Button>
                    </form>
                </div>
